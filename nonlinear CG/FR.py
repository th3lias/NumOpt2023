...
class FR:
    ...
    def beta(self, x, x_old):
        return (self.df(x).T @ self.df(x)) / (self.df(x_old).T @ self.df(x_old))

# main function
if __name__ == "__main__":
    # pass rosennbrock function with point (1.2, 1.2)
    fr = FR(lambda x: 100 * (x[1] - x[0] ** 2) ** 2 + (1 - x[0]) ** 2, lambda x: np.array([-400 * x[0] * (x[1] - x[0] ** 2) - 2 * (1 - x[0]), 200 * (x[1] - x[0] ** 2)]), np.array([1.2, 1.2]), 1e-6, np.array([1, 1]))
    ...
    fr = FR(lambda x: 100 * (x[1] - x[0] ** 2) ** 2 + (1 - x[0]) ** 2, lambda x: np.array([-400 * x[0] * (x[1] - x[0] ** 2) - 2 * (1 - x[0]), 200 * (x[1] - x[0] ** 2)]), np.array([-1.2, 1]), 1e-6, np.array([1, 1]))
    results, no_iter, x, grad_norm, distance_solution = fr.run()
    ...
    fr = FR(lambda x: 100 * (x[1] - x[0] ** 2) ** 2 + (1 - x[0]) ** 2, lambda x: np.array([-400 * x[0] * (x[1] - x[0] ** 2) - 2 * (1 - x[0]), 200 * (x[1] - x[0] ** 2)]), np.array([0.2, 0.8]), 1e-6, np.array([1, 1]))
    results, no_iter, x, grad_norm, distance_solution = fr.run()
    ...
    fr = FR(lambda x: 150 * (x[0] * x[1]) ** 2 + (0.5 * x[0] + 2 * x[1] - 2) ** 2, lambda x: np.array([(600 * x[0] * x[1] ** 2 + x[0] + 4*x[1] - 4)/2, 300 * x[0] ** 2 * x[1] + 2*x[0] + 8 * x[1] - 8]), np.array([-0.2, 1.2]), 1e-6, np.array([0, 1]))
    results, no_iter, x, grad_norm, distance_solution = fr.run()
    ...
    fr = FR(lambda x: 150 * (x[0] * x[1]) ** 2 + (0.5 * x[0] + 2 * x[1] - 2) ** 2, lambda x: np.array([(600 * x[0] * x[1] ** 2 + x[0] + 4*x[1] - 4)/2, 300 * x[0] ** 2 * x[1] + 2*x[0] + 8 * x[1] - 8]), np.array([3.8, 0.1]), 1e-6, np.array([4, 0]))
    results, no_iter, x, grad_norm, distance_solution = fr.run()
    ...
    fr = FR(lambda x: 150 * (x[0] * x[1]) ** 2 + (0.5 * x[0] + 2 * x[1] - 2) ** 2, lambda x: np.array([(600 * x[0] * x[1] ** 2 + x[0] + 4*x[1] - 4)/2, 300 * x[0] ** 2 * x[1] + 2*x[0] + 8 * x[1] - 8]), np.array([1.9, 0.6]), 1e-6, np.array([4, 0]))
